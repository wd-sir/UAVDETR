...
from ultralytics.nn.extra_modules import *  # SBA, RepNCSPELAN4, BasicBlock_WTConv, BottleNeck_WTConv, WTConv2d, TransformerEncoderLayer_SWSA
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, DSConv, Focus,
                 ...
                 ConvNormLayer, 
                 RepNCSPELAN4, ADown,
                 WTConv2d, BasicBlock_WTConv, BottleNeck_WTConv):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, ADown):
                args.insert(2, n)  # number of repeats
                n = 1
        elif m is TransformerEncoderLayer_SWSA:
            c2 = ch[f]
            args = [ch[f], *args]
        # Removed HGStem, HGBlock and related modules - not needed
